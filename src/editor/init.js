...
$(document).ready(function () {
  ...
  $(document).unbind('schema_loaded').bind('schema_loaded', function () {
    ...
    try {
      ...
      tmpResult = new Result(false, Messages.validity.configurationInvalid, [e]);
    ...
    if (false === config.isValid()) {
      tmpResult = new Result(false, Messages.validity.configurationInvalid, ['configuration not valid']);
      $(targetSelector).html(tmpResult.message);
      alert(tmpResult.message);
      return;
    }
